...
### What are they?
---
Sources are a way to award members with points in a [system](/modules/points/systems) automatically for performing an action. Each source can be customized to fit the server's needs.
