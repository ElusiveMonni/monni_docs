...
### Logging
***
With Logging, you can store things like **Deleted Messages** and **Role Changes** in channels you choose. There are are over 70+ logging events you can enable, so you can make sure nothing gets passed your eyes!
...
1. **First notice the panels on the right.** These are groups of similar events. You can check the boxes in the panel to enable or disable the group’s events!
