...
import apiSidebar from './docs/developer/api/sidebar.ts';
...

    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: true,
          // Generated by `npx docusaurus gen-api-docs public`. The info page is
          // already the category link, so it is dropped from the items here.
          items: apiSidebar.filter(
            (item) => !(item.type === 'doc' && item.id === 'developer/api/monni-public-api'),
          ),
        },
      ],
    },
